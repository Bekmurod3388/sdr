                    ...
                    <form action="{{route('admin.students.update',$data->id)}}" method="POST" accept-charset="UTF-8"
                      ...
                      @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{$data->name}}" class="form-control" id="header_ru" placeholder="Ism">
                        </div>
                        <div class="form-group">
                            <label for="header_ru">Familyani kiriting</label>
                            <input type="text" name="surname" value="{{$data->surname}}" class="form-control" id="header_ru" placeholder="Familya">
                        </div>
                        <div class="form-group">
                            <label for="header_ru">Sharifni kiriting</label>
                            <input type="text" name="f_s_name" value="{{$data->f_s_name}}" class="form-control" id="header_ru" placeholder="Sharif">
                        </div>
                        <div class="form-group">
                            <label for="header_ru">Manzilni kiriting</label>
                            <input type="text" name="address" value="{{$data->address}}" class="form-control" id="header_ru" placeholder="Manzil">
                        </div>
                        <div class="form-group">
                            <label for="header_ru">Pasport seriyasi va raqami</label>
                            <input type="text" name="passport" value="{{$data->passport}}" class="form-control" id="header_ru" placeholder="AA0000000">
                        </div>
                        <div class="form-group">
                            <label for="header_ru">Telefon raqami</label>
                            <input type="text" name="phone" value="{{$data->phone}}" class="form-control" id="header_ru" placeholder="+998883621700">
                        </div>
                        <div class="form-group">
                            <label for="header_ru">Ota-onasining ma'lumoti</label>
                            <input type="text" name="parent_name" value="{{$data->parent_name}}" class="form-control" id="header_ru" placeholder="Familya Ism Sharif">
                        </div>
                        <div class="form-group">
                            <label for="header_ru">Ota-onasining telefon raqami </label>
                            <input type="text" name="parent_phone" value="{{$data->parent_phone}}" class="form-control" id="header_ru" placeholder="+998883621700">
                        </div>
                        <div class="form-group">
                            <select name="room_id" class="form-select form-control form-select-lg mb-3" aria-label=".form-select-lg example">
                                ...
                                @foreach($rooms as $room)
                                    @if($room->id==$room_old->id) @continue  @endif
                        ...
                        <div class="form-group">
                            <select name="fak_id" class="form-select form-control form-select-lg mb-3" aria-label=".form-select-lg example">
                                ...
                                @foreach($fakultets as $fak)
                                    @if($fak->id==$fak_old->id) @continue  @endif
